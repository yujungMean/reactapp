    ...
    return (
        <S.Wrapper>
            <S.Inner>
                <S.SearchBoxWrap>
                    <S.SearchBox>
                        <S.SearchIcon src="/assets/picture/log-other-icon/material-icon-theme_gemini-ai.svg" alt="search" />
                        <S.SearchInput
                        ...
                        <S.SearchBtn onClick={handleSearch}>
                            <S.ArrowIcon src="/assets/picture/log-other-icon/la_arrow-up.svg" alt="submit" />
                        </S.SearchBtn>
                    </S.SearchBox>
                </S.SearchBoxWrap>
                ...
                <S.CategoryRow>
                    ...
                    <S.SortWrap ref={sortRef}>
                        <S.SortBtn onClick={() => setSortOpen(!sortOpen)}>
                            <span>{sort}</span>
                            <S.DownIcon src="/assets/picture/log-other-icon/down.svg" alt="down" $open={sortOpen} />
                        </S.SortBtn>
                        {sortOpen && (
                            <S.DropdownList>
