    ...
    return (
        <S.Wrapper>
            <S.Inner>
                ...
                <S.TitleWrap>
                    <S.TrumpetIcon src="/assets/picture/log-other-icon/1ee6415a019300001 1.png" alt="trumpet" />
                        ...
                        {cards.map((card, i) => (
                            <S.Card key={i}>
                                ...
                                <S.SolLabel>
                                    ...
                                    <S.SolIconWrap>
                                        <S.SolIcon src="/assets/picture/log-other-icon/chatbot_10541415.svg" alt="fero" />
                                    </S.SolIconWrap>
                                </S.SolLabel>
                ...
                <S.NavButtons>
                    <S.NavBtn onClick={handlePrev}>
                        <S.NavIconLeft src="/assets/picture/log-other-icon/uiw--right.svg" alt="prev" />
                    </S.NavBtn>
                    <S.NavBtn onClick={handleNext}>
                        <S.NavIcon src="/assets/picture/log-other-icon/uiw--right.svg" alt="next" />
                    </S.NavBtn>
                </S.NavButtons>
